...
namespace SilDev
{
    namespace Forms
    {
        ...
        {
            public static void DrawSplit(Button button, Color? buttonText = null)
            {
                try
                {
            ...
            public static bool Split_Click(Button button, ContextMenuStrip contextMenuStrip)
            {
            ...
            public static void Split_MouseMove(Button button, Color? backColor = null, Color? hoverColor = null)
            {
            ...
            public static void Split_MouseLeave(Button button)
            {
                if (button.BackgroundImage != null)
        ...
        {
            public static void DoubleBuffering(Control control, bool enable = true)
            {
                try
                {
        ...
        {
            public static void SetFixedSingle(ContextMenuStrip contextMenuStrip, PaintEventArgs paintEventArgs, Color? borderColor = null)
            {
                try
                {
        ...
        {
            public static void LinkText(LinkLabel linkLabel, string text, Uri uri)
            {
                try
                {
            ...
            public static void LinkText(LinkLabel linkLabel, string text, string uri)
            {
                try
                {
        ...
        {
            public static ListViewItem ItemFromPoint(ListView listView)
            {
                try
                {
        ...
        {
            public static void JumpToEnd(ProgressBar progressBar)
            {
                try
                {
        ...
        {
            public static void MarkText(RichTextBox richTextBox, string text, Color foreColor, Color? backColor = null, Font font = null)
            {
                try
                {
                    if (string.IsNullOrWhiteSpace(text))
        ...
        {
            public static void DrawSearchSymbol(TextBox textBox, Color? color = null)
            {
                try
                {
